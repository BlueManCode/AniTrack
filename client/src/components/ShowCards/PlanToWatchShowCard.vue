<template>
  <div v-if="!is_property_changed" class="plan-to-watch-card-container">
    <img :src="data.coverImage.large || data.coverImage.medium" />
    <div class="plan-to-watch-card-data-container">
      <div class="plan-to-watch-card-data-title">
        {{ data.title.english || "title not found" }}
      </div>
      <div class="plan-to-watch-card-sub-data-container">
        <div>
...
.plan-to-watch-card-container img {
  width: auto;
  height: 100%;
  border-radius: 6px 0 0 6px;
}

.plan-to-watch-card-data-container {
